      ...
      <div class="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
        ...
        <div>
          <div class="group relative">
            <div class="w-full min-h-80 bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75 rounded-md overflow-hidden lg:h-80 lg:aspect-none">
          ...
          <div class="flex items-center justify-between">
            ...
            <a href="{{ route('single_category',['id'=>$cat_id])}}">
              <p class="text-md font-medium text-gray-900">{{ $product->category->name }} </p>
            </a>
          </div>
